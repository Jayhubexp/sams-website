    ...
    <footer id="relume" className="px-[5%] py-12 md:py-18 lg:py-20">
      <div className="container">
        <div className="grid grid-cols-1 items-start gap-x-[8vw] gap-y-12 pb-12 md:gap-y-16 md:pb-18 lg:grid-cols-[1fr_0.5fr] lg:gap-y-4 lg:pb-20">
          <div className="grid grid-cols-1 items-start gap-x-8 gap-y-10 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 md:gap-x-6 lg:grid-cols-3">
            <a
              href="/"
        ...
        <div className="flex flex-col-reverse items-start pb-4 pt-6 text-sm md:justify-start md:pb-0 md:pt-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="mb-8 flex items-center justify-center gap-3 lg:mb-0">
            <a href="https://snapchat.com/t/qC4xmRs3" aria-label="Snapchat" target="_blank">
...
" aria-label="Instagram" target="_blank">
            ...
            <a href="https://x.com/SamuelJohn95977" aria-label="X" target="_blank">
              <FaXTwitter className="size-6 p-0.5" />
            </a>
            <a href="https://www.linkedin.com/in/samuel-sokpoli-49736123a/" aria-label="LinkedIn" target="_blank">
              <BiLogoLinkedinSquare className="size-6" />
            </a>
            <a href="https://t.me/brighttday" aria-label="Telegram" target="_blank">
